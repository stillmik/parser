...
import com.bsuir.entity.point.V_VN;
import com.bsuir.entity.point.V_VT;
import com.bsuir.entity.point.V_VT_VN;
...
public class FileParser {
  ...
  public Texture parse(String filePath) {
    ...
    return new Texture(vList, vtList, vnList, fList);
  }
    ...
    for (String num : nums) {
      if (num.contains("//")) {
        ...
        if (num.indexOf('/') == num.lastIndexOf('/')) {
          ...
          v_vt_vn.vt =
              Double.parseDouble(num.trim().substring(num.indexOf("/") + 1, num.lastIndexOf('/')));
